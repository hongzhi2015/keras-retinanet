...
def plot_diag_summ(desc, diag, out_dir):
    ...
    pr_fig = _plot_pr(desc, diag)
    pr_score_fig = _plot_pr_score(desc, diag)
...
def _plot_pr(desc, diag):
    ...
    mAP_str = "Mean average precision : {:0.2f}".format(diag.get_mAP())
